...
- **Minor Issues:**  
  ...
  - Service methods sometimes return Eloquent models directly instead of always wrapping in Resource classes, which can lead to inconsistent API responses.
